	  			...
	  			<table class="table table-bordered table-hover  table-condensed "  >
	      			<tr>
	       			...
	       			<tr>
	      				...
	      				<td><input type="date" name="dob" class="form-control form-control" required="required" maxlength="255" style="font-size: 15px;"></td>
	       			</tr>
					<tr>
					...
					<tr>
	      				...
	      				<td><input type="text" name="address" class="form-control form-control" placeholder="Address" required="required" maxlength="255" style="font-size: 15px;"></td>
	       			</tr>
					<tr>
	      				<th><label >Date of Joining :<span class="mandatory" style="color: red;">*</span></label></th>
	      				<td><input type="date" name="doj" class="form-control form-control" placeholder="Date of Joining" required="required" maxlength="255" style="font-size: 15px;"></td>
	       			</tr>
	       			<tr>
	       				<td colspan="2">
