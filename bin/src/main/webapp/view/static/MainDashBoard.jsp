...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"    pageEncoding="ISO-8859-1" import="java.util.*,com.ganesh.*,java.text.SimpleDateFormat"%>
 ...
 width: 100%;
  ...
  padding: 0;
      ...
      .charts {
        ...
        .distributed::before {
            background-color: rgb(185, 28, 214);
        }
        ...
        .pnc-do::before {
            background-color: rgb(161, 118, 39);
        }
     ...
     <h5 class="m-b-15"  style="color:black;"><b>DAK Closed</b></h5>
        ...
        <p class="m-b-0"><b><span class="f-left"  style="color:black; font-size: 18px; font-weight: 800;"><%if(GroupCardsCount[8]!=null){%><%=GroupCardsCount[8] %><%}else{%> <%} %></span></b></p>
         ...
         <label class="closed" style="font-size: 15px;">Closed</label>
          ...
          <div class="row overall" align="center" style="height: 33vh;  ">
<canvas id="myChart" style="width:100%;max-width:500px; margin-left: 50px;   padding: 5px; border: 1px solid #000; border-radius:10px; background-color: rgb(239, 239, 239);"></canvas>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<canvas id="mySecondChart" style="width:100%;max-width:500px; padding: 5px; border: 1px solid #000; border-radius:10px; background-color: rgb(239, 239, 239);"></canvas>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div id="myThirdChart" class="four col-md-3" style="margin-left: 70px; margin-top: 20px;">
		<div class="counter-box colored" align="center" style="height: 20vh; text-align: center; border-radius:10px;" >
		<span style="color: black; font-size: 25px; margin-top: 10px;">DAK SLA NEXT THREE DAYS</span><br><br>
			<span class="counter" style="color: black;"><%=NearDistributed%></span><br>
 		</div>
	</div>
...
var xValues = ["<%=MissedDistributed%>", "<%=MissedReplied%>", "<%=MissedRepliedByPnCDo%> ", "<%=MissedApproved%>" ,"<%=MissedClosed%>"];
var yValues = [<%=MissedDistributed%>, <%=MissedReplied%>, <%=MissedRepliedByPnCDo%>, <%=MissedApproved%>,<%=MissedClosed%>];
var barColors = ["rgb(185, 28, 214)","rgb(0, 0, 255)","rgb(161, 118, 39)","rgb(34, 139, 34)","rgb(249, 99, 2)"];
